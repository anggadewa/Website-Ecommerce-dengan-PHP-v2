...
$cariharga1 = $_GET['cariharga1'];
$cariharga2 = $_GET['cariharga2'];
$semuadata = array();
$ambildata = $koneksi->query("SELECT * FROM produk WHERE harga_produk BETWEEN '$cariharga1' AND '$cariharga2'");
                    ...
                    <div class="shop-bar-area">
                        ...
                        <div class="shop-product-content tab-content">
                            <div id="grid-sidebar3" class="tab-pane fade active show">
                                ...
                                <div class="alert alert-danger">Produk dengan harga <strong><?= $cariharga1; ?></strong>
                                    sampai dengan harga <strong><?= $cariharga2; ?></strong> Tidak Ditemukan
                                </div>
                                <?php endif ?>
                                <div class="row">
